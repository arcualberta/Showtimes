...
export const solrFields:SearchFieldDefinition[] = [
    ...
    { name: "lang_t", label: "Language", type: eFieldType.Text, options: [], entryType: eShowtimeEntryType.Movie },
    { name: "intl_country_t", label: "International Country", type: eFieldType.Text, options: [], entryType: eShowtimeEntryType.Movie },
    ...
    { name: "theater_country_t", label: "Theater country", type: eFieldType.Text, options: [], entryType: eShowtimeEntryType.Theater },
    ...
    { name: "theater_adult_child_t", label: "Theater child super", type: eFieldType.Text, options: [], entryType: eShowtimeEntryType.Theater },
    ...
    { name: "theater_discount_t", label: "Theater discount", type: eFieldType.Text, options: [], entryType: eShowtimeEntryType.Theater },
